                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                            	<form action="{{route('user.store')}}" method="POST">@csrf
                                    ...
                                    <div class="controls"> 
                                        <input type="text" name="CP" class="span8 @error('question') border-red @enderror" placeholder="CP" value=" {{old('CP')}}  " >
                                    </div>
                                     @error('CP')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="control-group">
                                    <label class="control-lable" for="occupation">Area</label>
                                    <div class="controls"> 
                                        <input type="text" name="area" class="span8 @error('question') border-red @enderror" placeholder="area" value=" {{old('area')}}  " >
                                    </div>
                                     @error('area')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="control-group">
                                    <label class="control-lable" for="company">Company's name</label>
                                    <div class="controls"> 
                                        <input type="text" name="company" class="span8 @error('question') border-red @enderror" placeholder="company" value=" {{old('company')}}  " >
                                    </div>
                                     @error('company')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
